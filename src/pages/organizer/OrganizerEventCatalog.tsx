...
import { getEventsByOrganizer, EventData } from "@/lib/db";
...
export const OrganizerEventCatalog = () => {
            ...
            <div className="max-w-4xl mx-auto space-y-6">
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-muted-foreground">Select an event to manage</p>
                    </div>
                    <Button onClick={() => navigate("/organizer/event-setup")} className="gap-2">
